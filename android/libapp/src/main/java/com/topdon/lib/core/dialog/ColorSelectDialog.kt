...
class ColorSelectDialog(context: Context, @ColorInt private var color: Int) : Dialog(context, R.style.InfoDialog) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val colorSelectView = rootView.findViewById<ColorPickerView>(R.id.color_select_view)
        val tvSave = rootView.findViewById<TextView>(R.id.tv_save)
        
        colorSelectView.selectColor(color)
        colorSelectView.setColorListener { colorEnvelope, _ ->
