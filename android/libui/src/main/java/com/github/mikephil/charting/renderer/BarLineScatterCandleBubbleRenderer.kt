...
abstract class BarLineScatterCandleBubbleRenderer(
     ...
     */
    protected val mXBounds = XBounds()
    ...
    protected fun isInBoundsX(e: Entry?, set: IBarLineScatterCandleBubbleDataSet<*>): Boolean {
        ...
        return !(e == null || entryIndex >= set.entryCount * mAnimator.phaseX)
    }
    ...
    protected inner class XBounds {
        ...
        fun set(chart: BarLineScatterCandleBubbleDataProvider, dataSet: IBarLineScatterCandleBubbleDataSet<*>) {
            ...
            min = entryFrom?.let { dataSet.getEntryIndex(it) } ?: 0
            max = entryTo?.let { dataSet.getEntryIndex(it) } ?: 0
