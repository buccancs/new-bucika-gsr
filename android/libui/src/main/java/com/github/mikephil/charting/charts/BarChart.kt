 ...
 */
class BarChart : BarLineChartBase<BarData>, BarDataProvider {
     ...
     * @return
     */
    fun isDrawValueAboveBarEnabled(): Boolean = mDrawValueAboveBar
     ...
     * @return
     */
    fun isDrawBarShadowEnabled(): Boolean = mDrawBarShadow
     ...
     */
    fun highlightValue(x: Float, dataSetIndex: Int, stackIndex: Int) {
        highlightValue(Highlight(x, dataSetIndex, stackIndex), false)
    }

    override fun getBarData(): BarData = mData
