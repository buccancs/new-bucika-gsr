...
class RadarChart : PieRadarChartBase<RadarData> {
    ...
    private lateinit var mYAxisRenderer: YAxisRendererRadarChart
    private lateinit var mXAxisRenderer: XAxisRendererRadarChart
     ...
     * @return
     */
    fun getSliceAngle(): Float = 360f / mData.maxEntryCountSet.entryCount.toFloat()
    ...
    fun getWebLineWidth(): Float = mWebLineWidth
    ...
    fun getWebLineWidthInner(): Float = mInnerWebLineWidth
    ...
    fun getWebColorInner(): Int = mWebColorInner
     ...
     * @return
     */
    fun getSkipWebLineCount(): Int = mSkipWebLineCount

    override fun getRequiredLegendOffset(): Float = mLegendRenderer.labelPaint.textSize * 4f

    override fun getRequiredBaseOffset(): Float {
        return if (mXAxis.isEnabled && mXAxis.isDrawLabelsEnabled) {
    ...
    /**
     * Returns the maximum value this chart can display on its y-axis.
     */
    fun getYChartMax(): Float = mYAxis.mAxisMaximum

    /**
     * Returns the minimum value this chart can display on its y-axis.
     */
    fun getYChartMin(): Float = mYAxis.mAxisMinimum
     ...
     * @return
     */
    fun getYRange(): Float = mYAxis.mAxisRange
}